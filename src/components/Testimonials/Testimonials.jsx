...
//                         <p className='text-xl py-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est facilis recusandae ad fugit excepturi, cumque sit dolorum eaque rem facere aut omnis, harum iure blanditiis qui accusantium vel! Hic, animi.</p>
...
//                                 <img className='w-20 h-20 rounded-full border-2' src="https://media.istockphoto.com/id/1069673870/photo/young-male-college-student.jpg?s=612x612&w=0&k=20&c=YI_HyAqEgRxiqwq7EYMMuxwhHRdeMfGi49Ne-u93KLY=" alt="student_image" />
//                                 <div>
//                                     <h3 className='text-xl font-semibold'>Admed Uddin</h3>
//                                     <p>Batch-10</p>
//                                 </div>
//                             </div>
...
//                             {/* quatation icon */}
//                             <div>
//                                     <p><FaQuoteRight className='text-4xl'/></p>
//                             </div>
//                         </div>

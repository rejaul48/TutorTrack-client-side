            ...
            <section>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 px-2 xl:px-0'>
                    ...
                    <div className="relative group overflow-hidden rounded-md cursor-pointer">
                        <img
                            className="w-full h-auto md:h-[480px] rounded-md object-cover transition-transform duration-300 group-hover:scale-105"
                    ...
                    <div className="relative group overflow-hidden rounded-md cursor-pointer">
                        ...
                        <img className='className="w-full h-auto md:h-[480px] rounded-md object-cover transition-transform duration-300 group-hover:scale-105 w-full' src="https://i.imgur.com/SrZUyYW.jpeg" alt="teachers-image" />
                    ...
                    <div className="relative group overflow-hidden rounded-md cursor-pointer">
                        <img className=' className="w-full h-auto md:h-[480px] rounded-md object-cover transition-transform duration-300 group-hover:scale-105 w-full' src="https://i.imgur.com/VewhFF3.jpeg" alt="teachers-image" />
                        {/* Overlay */}
                        <div className="absolute inset-0 bg-gradient-to-t from-[#493D9E]/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    ...
                    <div className="relative group overflow-hidden rounded-md cursor-pointer">
                        <img className=' className="w-full h-auto md:h-[480px] rounded-md object-cover transition-transform duration-300 group-hover:scale-105 w-full' src='https://i.imgur.com/e8UlYwz.jpeg' alt="teachers-image" />
                        {/* Overlay */}
                        <div className="absolute inset-0 bg-gradient-to-t from-[#493D9E]/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
